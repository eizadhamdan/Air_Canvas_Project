...
# Initializing different arrays to handle colour points of different colour
...
# Canvas setup
paintWindow = np.zeros((800, 800, 3)) + 255
...
while ret:
    ...
    if result.multi_hand_landmarks:
        ...
        # if the index finger and thumb are very close to each other, then stop drawing
        ...
        # trigger the buttons (and stop drawing)
        elif center[1] <= 65:
